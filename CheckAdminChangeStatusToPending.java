...
public class CheckAdminChangeStatusToPending {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement( By.id( "dropdown-split-basic" ) ).click();
        driver.findElement( By.xpath( "/html/body/div[3]/div/div/div/div/div[2]/div[2]/div[1]/div[2]/form/div[2]/div/div/a[2]" ) ).click();
        Thread.sleep(1000);

        driver.findElement( By.xpath( "/html/body/div[3]/div/div/div/div/div[2]/div[2]/div[1]/div[2]/form/div[2]/div/button[1]" ) ).click();
