...
public class CheckAdminChangeTicketType {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Select selectIssue = new Select(driver.findElement( By.xpath("/html/body/div[3]/div/div/div/div/div[1]/div/select[2]") ));

        selectIssue.selectByVisibleText( "Problem" );
