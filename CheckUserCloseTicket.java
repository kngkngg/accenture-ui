...
public class CheckUserCloseTicket {
    static String myUserName = "haha@ha";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        java.util.List<WebElement> userLinks = driver.findElements( By.tagName("span"));
        for(int i=0;i<userLinks.size();i++ ){
            if(userLinks.get(i).getText().equals( "CLOSE TICKET" )){
