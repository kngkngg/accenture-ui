...
public class CheckAdminDashboardContextSwitch {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        java.util.List<WebElement> nav_links = driver.findElements( By.tagName("a"));
        for (int i = 0; i < nav_links.size(); i=i+1) {
            if(nav_links.get(i).getText().equals( "View Tickets" )){
                Thread.sleep(1000);
                nav_links.get( i ).click();
