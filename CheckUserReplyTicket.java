...
public class CheckUserReplyTicket {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        wait.until( ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[1]"))).click();


        WebElement response = driver.findElement(By.xpath("//*[@id=\"reply\"]"));
        Thread.sleep(1000);
        response.sendKeys(myResponse);
        WebElement buttons = driver.findElement( By.xpath("/html/body/div[3]/div/div/div[2]/div[1]/div[2]/form/div[2]/div/button[1]"));
        Thread.sleep(1000);
        buttons.click();
