...
public class CheckAdminLogOut {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        java.util.List<WebElement> Adminlinks = driver.findElements( By.tagName("a"));
        for (int i=0; i<Adminlinks.size(); i++){
            if(Adminlinks.get(i).getText().equals( "Log out")){
                Thread.sleep(1000);
                Adminlinks.get( i ).click();
            }
        }
